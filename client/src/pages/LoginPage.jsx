...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly
      ...
      {/* ************ left ************************ */}
      <img src={assets.logo_big} alt='' className='h-100 w-100' />
      ...
      <form onSubmit={onSubmitHandler}
        ...
        <button type="submit"
          className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-white rounded-md cursor-md cursor-pointer'>
